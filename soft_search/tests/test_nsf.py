...
@pytest.mark.parametrize(
    ...
    [
        ...
        (datetime(2019, 1, 1), datetime(2020, 1, 1), [NSFFields.id_, NSFFields.projectOutComesReport], 28,),
...
def test_get_nsf_dataset(start_date: Union[str, datetime], end_date: Union[str, datetime], dataset_fields: List[str], expected_length: int,) -> None:
    df = get_nsf_dataset(
