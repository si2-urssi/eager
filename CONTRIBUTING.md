...
Ready to contribute? Here's how to set up `soft-search` for local development.

1. Fork the `soft-search` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/soft-search.git
    ```
